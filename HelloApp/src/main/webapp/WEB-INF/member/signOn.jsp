...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="signOn.do" enctype="multipart/form-data" method="post">
    <div class="container">
      ...
      <label for="member_phone"><b>Phone</b></label>
      <input type="text" placeholder="Enter Phone" name="member_phone">
      
      <label for="image"><b>Image</b></label>
      <input type="file" placeholder="Enter Image" name="image" multiple>
